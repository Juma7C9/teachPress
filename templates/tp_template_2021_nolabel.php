...
class TP_Template_2021_nolabel implements TP_Publication_Template {
    /**
     * Returns the settings of the template
     * @return array
     */
    public function get_settings() {
        return array ('name'                => 'teachPress 2021_nolabel',
                      'description'         => 'A new mobile friendly 4 line style template for publication lists, without publication type label.',
